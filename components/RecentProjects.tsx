...
const RecentProjects = () => {
  return (
    <div id="projects" className="text-white-100 py-20">
      ...
      <div
        ...
        justify-center p-4 gap-x-72 gap-y-8 mt-10"
      >
        {projects.map(({ id, title, des, iconLists, img, link }) => (
          <div
            key={id}
            className="sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem]  
          flex items-center  justify-center sm:w-96 w-[80vw] sm:w-570px"
          >
            <PinContainer title={link} href={link}>
              <div
                className="relative flex items-center justify-center 
                sm:w-[570px] w-[80vw] sm:h=[40vh] overflow-hidden h-[30vh] mb-10"
              >
                <div
